<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top py-5 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container"><a class="navbar-brand" href="index.html"><img src="{{url('frontend/assets/img/logo.svg')}}" height="34" alt="logo" /></a>
